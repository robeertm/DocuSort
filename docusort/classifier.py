...
class Classification:
    ...
    due_date: str = ""                 # optional ISO deadline (payment/cancel)
...
- Optional keys: due_date, due_kind. Include them ONLY when the document states a concrete deadline; otherwise set both to "".
...
- "Bon-Nr.", "Beleg-Nr.", "TA-Nr", "BNr", "Bon: 1"
- "Kasse 02", "Kassierer", "VkSt", "Bed:031627"
- "Terminal-ID", "Terminalnummer 10000002"
...
Output:
{"category":"Rechnungen","subcategory":"","tags":["mobilfunk"],"date":"2026-02-14","sender":"Vodafone GmbH","subject":"Mobilfunkrechnung Februar 2026","confidence":0.95,"reasoning":"Klar erkennbare Mobilfunkrechnung mit Rechnungsnummer und Fälligkeit.","due_date":"2026-02-28","due_kind":"zahlung"}
...
Input (excerpt):
"Finanzamt Musterstadt · Bescheid für 2024 über Einkommensteuer · Steuer-Nr. 203/150/12345 · Datum 20.03.2026 · Festsetzung: Erstattung 412,00 EUR"

Output:
{"category":"Steuer","subcategory":"","tags":["bescheid","einkommensteuer"],"date":"2026-03-20","sender":"Finanzamt Musterstadt","subject":"Einkommensteuerbescheid 2024","confidence":0.97,"reasoning":"Offizieller Einkommensteuerbescheid vom Finanzamt mit Steuernummer."}
...
Input (excerpt):
"Sparkasse Musterstadt · Kontoauszug Nr. 03/2026 · Konto-Inhaber: Max Mustermann · IBAN DE02 1203 0000 0000 2020 51 · Buchungszeitraum 01.03.2026 bis 31.03.2026 · Saldo: 4.218,54 EUR"

Output:
{"category":"Bank","subcategory":"Konto","tags":["kontoauszug"],"date":"2026-03-31","sender":"Sparkasse Musterstadt","subject":"Kontoauszug Marz 2026","confidence":0.96,"reasoning":"Kontoauszug der Sparkasse mit IBAN, Buchungszeitraum und Saldo."}
...
Input (excerpt):
"Hausverwaltung Müller & Co. · Nebenkostenabrechnung 2024 · Objekt: Musterstraße 12, 04910 Musterstadt · Abrechnungszeitraum 01.01.2024–31.12.2024 · Nachzahlung 212,45 EUR"
...
Input (excerpt):
"Mietvertrag — Wohnung · Vermieter: Heinrich Berger, Musterstraße 45, 04910 Musterstadt · Mieter: Max Mustermann · Mietbeginn: 01.05.2026 · Kaltmiete 780,00 EUR · Nebenkostenvorauszahlung 180,00 EUR · Unterschriftsdatum 12.04.2026"

Output:
{"category":"Haus","subcategory":"Miete","tags":["vertrag"],"date":"2026-04-12","sender":"Heinrich Berger","subject":"Mietvertrag Wohnung Musterstadt","confidence":0.96,"reasoning":"Unterschriebener Mietvertrag — Wohnen → Haus/Miete."}
...
Input (excerpt):
"Große Kreisstadt Musterstadt · Bescheid über die Festsetzung der Grundsteuer B für das Jahr 2026 · Aktenzeichen GS-2026/0045 · Datum 12.02.2026 · Jahresbetrag 428,00 EUR"

Output:
{"category":"Behoerde","subcategory":"Sonstiges","tags":["bescheid","grundsteuer"],"date":"2026-02-12","sender":"Stadt Musterstadt","subject":"Grundsteuerbescheid 2026","confidence":0.94,"reasoning":"Grundsteuerbescheid von der Gemeinde — Behoerde, nicht Steuer."}
...
Input (excerpt):
"REWE Markt GmbH · Marktstraße 78 · 04910 Musterstadt · Bon-Nr. 4711 · Kasse 02 · Datum 12.04.2026 17:42 · Bio Vollmilch 1L 1,29 · Vollkornbrot 2,49 · Tomaten 500g 1,79 · ... SUMME 23,87 EUR · girocard"

Output:
{"category":"Kassenzettel","subcategory":"Supermarkt","tags":["lebensmittel"],"date":"2026-04-12","sender":"REWE","subject":"Einkauf REWE Musterstadt 23,87 EUR","confidence":0.95,"reasoning":"Klassischer Supermarkt-Kassenbon mit Artikelzeilen und SUMME."}
...
Input (excerpt):
"ALDI · Marktweg 7, 04910 Musterstadt · -8 x 0,25 € LEERGUTRÜCKNAHME 19% -2,00 € 2 · SPITZPAPRIKA MIX 2,19 € 1 · OATLY BARISTA HAFERDRI 5,10 € 2 · TK PIZZA GIGANTE 3,49 € 1 · PFANDWERT 1,50 1,50 € 2 · 0,463 kg x 11,99 €/kg SCHWEINEFILET-QS 5,55 € 1 · ZU ZAHLEN 149,11 € · -K-U-N-D-E-N-B-E-L-E-G- · Terminal-ID 10000001 · TA-Nr 100001 · BNr 1001 · Kartenzahlung kontaktlos girocard · EUR 149,11 · ALDI SE & Co. KG, Sitz: Musterstadt · USt. ID: DE100000001"

Output:
{"category":"Kassenzettel","subcategory":"Supermarkt","tags":["lebensmittel","einkauf"],"date":"2026-04-29","sender":"ALDI","subject":"Einkauf ALDI Musterstadt 149,11 EUR","confidence":0.96,"reasoning":"Lange Artikelliste, ZU ZAHLEN, Pfand-Zeilen, Terminal-ID + TA-Nr + K-U-N-D-E-N-B-E-L-E-G — eindeutig Supermarkt-Kassenbon trotz GmbH-Footer und USt-IdNr."}

## Example 15d — Deichmann Schuh-Bon (article numbers + Kartenzahlungsbeleg)

Input (excerpt):
"DEICHMANN · Deichmann SE · Musterallee 12, 04910 Musterstadt · USt-IdNr. DE100000002 · 1 5331020 1 |36 |01|01 24,99 Graceland · 2 9920886 1 |33-36 |01|01 6,99 Fila · 8 900001 1 |unbekan|01|01 0,10 Tragetasche · SUMME EUR 32,08 · girocard EUR 32,08 · Rückgeld EUR 0,00 · MwSt 0=19,00% 26,96 5,12 · Datum 28.04.2026 · Bon: 1"

Output:
{"category":"Kassenzettel","subcategory":"Bekleidung","tags":["schuhe"],"date":"2026-04-28","sender":"Deichmann","subject":"Schuhkauf Deichmann Musterstadt 32,08 EUR","confidence":0.95,"reasoning":"Schuh-/Schuhzubehör-Kassenbon mit Artikelnummern, SUMME EUR, girocard-Zahlung, Bon-Nr."}

## Example 15e — Cineplex Snackbon (Kino-Imbiss → Restaurant/Cafe)

Input (excerpt):
"Kino am Markt · 04910 Musterstadt · Menü 2 Nacho 10,00 EUR · 1 * 10,00 EUR · 1 * Coca-Cola 0,75l · 1 * Nachos Klein · 1 * Salsa-Dip hot · Summe : 10,00 EUR · Telecash Kasse 10,00 EUR · MwSt. 19,00 % (4,13 EUR): 0,78 EUR · Datum: 03.05.26 · Uhrzeit: 16:37"

Output:
{"category":"Kassenzettel","subcategory":"Cafe","tags":["kino","snack"],"date":"2026-05-03","sender":"Cineplex","subject":"Kino-Snack Cineplex Musterstadt 10,00 EUR","confidence":0.93,"reasoning":"Kino-Snackbar-Bon mit Menü-Combo, Telecash-Kasse, MwSt-Tabelle."}

## Example 15f — Standalone Kartenzahlungsbeleg (no items, but still Kassenzettel)

Input (excerpt):
"DEICHMANN · Deichmann SE · Musterallee 12, 04910 Musterstadt · USt-IdNr. DE100000002 · Kartenzahlung girocard Contactless · Terminalnummer 10000002 · Datum 28.04.2026 · Uhrzeit 17:46:24 · POS/TrxNummer 1/1 · Transakt.-Nr. 00010001 · Kartennummer XXXXXXXXXXXXXXXX0000 · VU-Nummer 100003 · Autorisierungsnr. 100004 · Betrag 32,08 EUR · 00 Zahlung erfolgt"
...
- **Sender too long**: shorten intelligently — "Allianz Versicherungs-AG" → "Allianz"; "Techniker Krankenkasse" → "TK" is fine if that's the common usage; "Stadtwerke Musterstadt GmbH" → "Stadtwerke Musterstadt".
...
Optionally add due_date (ISO) and due_kind ("zahlung"|"kuendigung") when the document states a concrete payment or cancellation deadline; otherwise set both to "".
...
def _normalise_due_date(raw: Any) -> str:
    """Coerce an extracted deadline to ISO YYYY-MM-DD, or "" if unusable.

    Reuses the finance date parser (handles ISO + German DD.MM.YYYY). We
    also drop obviously-bogus far-past/future dates so a mis-read OCR
    string can't plant a nonsense reminder."""
    from datetime import date as _date
    from .finance.dates import normalise_date
    iso = normalise_date(str(raw or "").strip())
    if not iso:
        return ""
    try:
        y = int(iso[:4])
        ...
        return ""
    # Keep it within a sensible band around now (deadlines are near-term).
    this_year = _date.today().year
    if y < this_year - 5 or y > this_year + 15:
        return ""
    return iso
...
class Classifier:
    ...
    def classify(self, text: str) -> Classification:
        ...
        for attempt in range(2):
            try:
                resp = self.provider.classify(
                    ...
                    # A classification is a single small JSON object, so
                    # a few hundred output tokens is always enough. We do
                    # NOT set a huge cap here: the local bridge derives
                    # its per-call timeout from max_output_tokens (~8
                    # tok/s), so an oversized value produced a multi-hour
                    # timeout that let one hung Mac wedge a pipeline slot.
                    # Configurable via ai.classify_max_tokens for the rare
                    # model that needs more headroom.
                    max_output_tokens=max(256, self.settings.classify_max_tokens),
                )
        ...
        # Deadline extraction — normalise to ISO and only keep a sane
        # future-ish date. due_kind must pair with a real due_date.
        due_date = _normalise_due_date(data.get("due_date", ""))
        due_kind = str(data.get("due_kind", "") or "").strip().lower()
        if due_kind not in ("zahlung", "kuendigung"):
            due_kind = ""
        if not due_date:
            due_kind = ""
